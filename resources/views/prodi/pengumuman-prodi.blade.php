                                     ...
                                     <td>{{$data->keterangan}}</td>
                                      ...
                                      <td> 
                                        @if($data->id_user == Auth::user()->id)
                                            <a href="{{route('prodi-get_edit_pengumuman', ['id' => $data->id])}}">
                                        ...
                                        @endif
                                            <a href="{{route('prodi-lihat_pengumuman', ['id' => $data->id])}}">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form method="post" action="{{url('prodi-tambah_pengumuman')}}" enctype="multipart/form-data">
...
<!-- Modal konfirmasi Hapus -->
 ...
 <script type="text/javascript">
        function deleteData(id) {
            var id = id;
            var url = '{{route("prodi-hapus_pengumuman", ":id") }}';
