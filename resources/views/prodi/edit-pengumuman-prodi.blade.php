 ...
 <div class="col-lg-8">
              <div class="card">
                <div class="card-header">
                  <h4>ini Edit pengumuman Prodi</h4>
                </div>
              <div class="card-body">
                   ...
                   @if (session('success'))
                            ...
                            @endif
                   <form method="post" action="{{url('/prodi-edit_gambar',$data->id)}}" enctype="multipart/form-data">
                 ...
                 <form method="post" action="{{url('/prodi-proses_edit_pengumuman',$data->id)}}" enctype="multipart/form-data">
