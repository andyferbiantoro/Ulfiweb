...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card-header">
            <h4 style="margin-right: 60%;">Data Dosen Tidak Tetap</h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Dosen Tidak Tetap</h5>

            </div>
            <div class="modal-body">
                <form method="post" action="{{route('prodi_profil_dosen_dosen_tidak_tetap_add')}}" enctype="multipart/form-data">
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{route("prodi_profil_dosen_dosen_tidak_tetap_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    $('#jabatan_akademik_update').val(data[5]);
    $('#link_sertifikat_pendidik_update').val(data[7]);
    $('#link_sertifikat_kompetensi_update').val(data[9]);
    $('#matakuliah_prodi_diakreditasi_update').val(data[10]);
    $('#kesesuaian_bidang_keahlian_update').val(data[11]);
    $('#link_bukti_dokumen_update').val(data[13]);
    $('#tahun_update').val(data[14]);
    $('#UpdateModalform').attr('action','prodi_profil_dosen_dosen_tidak_tetap_update/'+ data[16]);
