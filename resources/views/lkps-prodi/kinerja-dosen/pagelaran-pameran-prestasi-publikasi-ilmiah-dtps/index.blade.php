    ...
    <div class="col-lg-12">
        ...
        @endif
            <div class="card-header">
                <h4 style="margin-right: 17%;">Data Pagelaran/Pameran/Presentasi/Publikasi Ilmiah DTPS</h4>
                <div class=" text-right">
                    <button type="button" class="btn btn-success fa fa-plus" data-toggle="modal" data-target="#ModalTambah">
                        Tambah Data
                    </button>
                    <a href="{{route('prodi_lihat_kinerja_dosen_pagelaran_pameran_prestasi_publikasi_ilmiah_dtps')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Pagelaran/Pameran/Publikasi Ilmiah DTPS</h5>
                @if (session('success'))
                <div class="alert alert-success">
                    {{ session('success') }}
                </div>
            ...
            <div class="modal-body">
                <form method="post" action="{{route('prodi_kinerja_dosen_pagelaran_pameran_prestasi_publikasi_ilmiah_dtps_add')}}" enctype="multipart/form-data">
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{route("prodi_kinerja_dosen_pagelaran_pameran_prestasi_publikasi_ilmiah_dtps_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    $('#updateModalform').attr('action','prodi_kinerja_dosen_pagelaran_pameran_prestasi_publikasi_ilmiah_dtps_update/'+ data[10]);
