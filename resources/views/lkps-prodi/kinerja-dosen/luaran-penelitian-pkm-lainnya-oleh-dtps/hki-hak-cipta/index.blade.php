...
@section('title')
HKI (Hak Cipta, Desain Produk Industri)
@endsection
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card-header">
            <h4 style="margin-right: 45%;">Data HKI (Hak Cipta, Desain Produk Industri)</h4>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="dataTable" class="table table-hover">
                    ...
                    <tbody>
                        @php $no=1 @endphp
                        @foreach($data_hki_hak_cipta as $data)
                        <tr>
                            <td>{{$no++ }}</td>
                            <td>{{$data->luaran_penelitian_pkm }}</td>
                            <td>{{$data->tahun }}</td>
                            <td>{{$data->keterangan }}</td>
                            <td><a href="{{route('prodi-file_download_file_hki_hak_cipta',$data->id)}}"><button class="btn btn-info ">Download</button></a></td>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p style="font-size: 10px;">
                    ...
                    b. Hak Cipta <br>
                    c. HKI (Hak Kekayaan Intelektual) <br>
                    d. Surat Pencatatan Ciptaan <br>
                    e. Laporan Akhir Penelitian/ Jurnal
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('prodi_kinerja_dosen_hki_hak_cipta_add')}}" enctype="multipart/form-data">
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{route("prodi_kinerja_dosen_hki_hak_cipta_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    $('#updateModalform').attr('action','prodi_kinerja_dosen_hki_hak_cipta_update/'+ data[7]);
