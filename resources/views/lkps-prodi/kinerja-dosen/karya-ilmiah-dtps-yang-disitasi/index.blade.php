...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card-header">
            <h4 style="margin-right: 50%;">Data Karya Ilmiah DTPS yang Disitasi</h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Karya Ilmiah DTPS yang Disitasi</h5>
                
            </div>
            <div class="modal-body">
                <form method="post" action="{{route('prodi_kinerja_dosen_karya_ilmiah_dtps_yang_disitasi_add')}}" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label for="judul">Judul Artikel yang Disitasi (Jurnal, Volume, Tahun, Nomor, Halaman)</label>
                    <input type="text" class="form-control" id="judul_artikel" name="judul_artikel" required="" />
                </div>

                <div class="form-group">
                    <label for="judul">Jumlah Sitasi</label>
                    <input type="text" class="form-control" id="jumlah_sitasi" name="jumlah_sitasi" required="" />
                </div>


                <div class="form-group">
                    <label for="judul">Unggah File Bukti Sitasi (opsional)</label>
                    <input type="file" class="form-control" id="file_bukti_sitasi" name="file_bukti_sitasi" />
                </div>

                <div class="form-group">
                    <label for="judul">Link Bukti Sitasi (opsional)</label>
                    <input type="text" class="form-control" id="link_bukti_sitasi" name="link_bukti_sitasi" />
                </div>
...
<div id="updateModal" class="modal fade" role="dialog">
  ...
  <div class="modal-body">
    ...
    <div class="form-group">
        <label for="judul">Judul Artikel yang Disitasi (Jurnal, Volume, Tahun, Nomor, Halaman)</label>
        <input type="text" class="form-control" id="judul_artikel_update" name="judul_artikel" required="" />
    </div>

    <div class="form-group">
        <label for="judul">Jumlah Sitasi</label>
        <input type="text" class="form-control" id="jumlah_sitasi_update" name="jumlah_sitasi" required="" />
    </div>


    <div class="form-group">
        <label for="judul">Unggah File Bukti Sitasi (opsional)</label>
        <input type="file" class="form-control" id="file_bukti_sitasi_update" name="file_bukti_sitasi" />
    </div>

    <div class="form-group">
        <label for="judul">Link Bukti Sitasi (opsional)</label>
        <input type="text" class="form-control" id="link_bukti_sitasi_update" name="link_bukti_sitasi" />
    </div>
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{route("prodi_kinerja_dosen_karya_ilmiah_dtps_yang_disitasi_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    $('#judul_artikel_update').val(data[2]);
    $('#jumlah_sitasi_update').val(data[3]);
    $('#link_bukti_sitasi_update').val(data[5]);
    $('#tahun_update').val(data[6]);
    $('#updateModalform').attr('action','prodi_kinerja_dosen_karya_ilmiah_dtps_yang_disitasi_update/'+ data[8]);
