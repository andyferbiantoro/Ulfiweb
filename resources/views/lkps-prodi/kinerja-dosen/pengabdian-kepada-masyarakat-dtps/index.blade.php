...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card-header">
            <h4 style="margin-right: 25%;">Data Pengabdian kepada Masyarakat (PkM) DTPS</h4>
            <div class=" text-right">
                <button type="button" class="btn btn-success fa fa-plus" data-toggle="modal" data-target="#ModalTambah">
                    Tambah Data
                </button>
                <a href="{{route('prodi_lihat_kinerja_dosen_pengabdian_kepada_masyarakat_dtps')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Pengabdian Kepada Masyarakat DTPS</h5>

            </div>
            <div class="modal-body">
                <form method="post" action="{{route('prodi_kinerja_dosen_pengabdian_kepada_masyarakat_dtps_add')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="judul">Jumlah Judul Pengabdian kepada Masyarakat (PkM) DTPS</label>
                        <input type="text" class="form-control" id="jumlah_judulPkm_ts2" name="jumlah_judulPkm_ts2" required="" placeholder="TS-2" /><br>
                        <input type="text" class="form-control" id="jumlah_judulPkm_ts1" name="jumlah_judulPkm_ts1" required="" placeholder="TS-1" /><br>
                        <input type="text" class="form-control" id="jumlah_judulPkm_ts" name="jumlah_judulPkm_ts" required="" placeholder="TS" />
...
<div id="updateModal" class="modal fade" role="dialog">
  ...
  <div class="modal-body">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="jumlah_judulPkm_ts2_update" name="jumlah_judulPkm_ts2" required="" placeholder="TS-2" /><br>
        <input type="text" class="form-control" id="jumlah_judulPkm_ts1_update" name="jumlah_judulPkm_ts1" required="" placeholder="TS-1" /><br>
        <input type="text" class="form-control" id="jumlah_judulPkm_ts_update" name="jumlah_judulPkm_ts" required="" placeholder="TS" />
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{route("prodi_kinerja_dosen_pengabdian_kepada_masyarakat_dtps_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    $('#jumlah_judulPkm_ts2_update').val(data[2]);
    $('#jumlah_judulPkm_ts1_update').val(data[3]);
    $('#jumlah_judulPkm_ts_update').val(data[4]);
    $('#tahun_akademik_update').val(data[6]);
    $('#link_bukti_dokumen_update').val(data[8]);
    $('#updateModalform').attr('action','prodi_kinerja_dosen_pengabdian_kepada_masyarakat_dtps_update/'+ data[10]);
