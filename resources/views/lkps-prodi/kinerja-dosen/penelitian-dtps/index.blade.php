...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card-header">
            <h4 style="margin-right: 50%;">Data Penelitian DTPS</h4>
            <div class=" text-right">
                <button type="button" class="btn btn-success fa fa-plus" data-toggle="modal" data-target="#ModalTambah">
                    Tambah Data
                </button>
                <a href="{{route('prodi_lihat_kinerja_dosen_penelitian_dtps')}}">
                    ...
                    <table id="" class="table table-hover">
                        ...
                        <tbody>
                         ...
                         <tr>
                            ...
                            <td style="text-align: center; vertical-align: middle;">{{$data->jumlah_judulPenelitian_ts2 }}</td>
                            <td style="text-align: center; vertical-align: middle;">{{$data->jumlah_judulPenelitian_ts1 }}</td>
                            <td style="text-align: center; vertical-align: middle;">{{$data->jumlah_judulPenelitian_ts }}</td>
                            ...
                            <td style="text-align: center; vertical-align: middle;"><a href="{{route('prodi-file_download_file_bukti_dokumen',$data->id)}}"><button class="btn btn-info ">Download</button></a></td>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p style="font-size: 10px;">
                    ...
                    2. Jumlah judul Penelitian berdasarkan sumber pembiayaan yang dilaksanakan oleh DTPS, yang relevan dengan bidang
                    ...
                    a. Surat Keputusan Tentang Penelitian <br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Penelitian DTPS</h5>
                @if (session('success'))
                <div class="alert alert-success">
                    {{ session('success') }}
                </div>
            ...
            <div class="modal-body">
                <form method="post" action="{{route('prodi_kinerja_dosen_penelitian_dtps_add')}}" enctype="multipart/form-data">

                    {{csrf_field()}}
                    <div class="form-group">
                        <label for="judul">Sumber Pembiayaan</label>
                        <select type="text" class="form-control" id="sumber_pembiayaan" name="sumber_pembiayaan">
                            <option >Perguruan Tinggi</option>
                            <option >Mandiri</option>
                            <option >Lembaga Dalam Negeri (di Luar PT)</option>
                            <option >Lembaga Lura Negeri</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="judul">Jumlah Judul Penelitian</label>
                        <input type="text" class="form-control" id="jumlah_judulPenelitian_ts2" name="jumlah_judulPenelitian_ts2" required="" placeholder="TS-2" /><br>
                        <input type="text" class="form-control" id="jumlah_judulPenelitian_ts1" name="jumlah_judulPenelitian_ts1" required="" placeholder="TS-1" /><br>
                        <input type="text" class="form-control" id="jumlah_judulPenelitian_ts" name="jumlah_judulPenelitian_ts" required="" placeholder="TS" />
...
<div id="updateModal" class="modal fade" role="dialog">
  ...
  <div class="modal-body">
    ...
    <div class="form-group">
        <label for="judul">Sumber Pembiayaan</label>
        <select type="text" class="form-control" id="sumber_pembiayaan_update" name="sumber_pembiayaan">
            <option >Perguruan Tinggi</option>
            <option >Mandiri</option>
            <option >Lembaga Dalam Negeri (di Luar PT)</option>
            <option >Lembaga Lura Negeri</option>
    ...
    <div class="form-group">
        <label for="judul">Jumlah Judul Penelitian</label>
        <input type="text" class="form-control" id="jumlah_judulPenelitian_ts2_update" name="jumlah_judulPenelitian_ts2" required="" placeholder="TS-2" /><br>
        <input type="text" class="form-control" id="jumlah_judulPenelitian_ts1_update" name="jumlah_judulPenelitian_ts1" required="" placeholder="TS-1" /><br>
        <input type="text" class="form-control" id="jumlah_judulPenelitian_ts_update" name="jumlah_judulPenelitian_ts" required="" placeholder="TS" />
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{route("prodi_kinerja_dosen_penelitian_dtps_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    console.log(data);
    $('#sumber_pembiayaan_update').val(data[1]);
    $('#jumlah_judulPenelitian_ts2_update').val(data[2]);
    $('#jumlah_judulPenelitian_ts1_update').val(data[3]);
    $('#jumlah_judulPenelitian_ts_update').val(data[4]);
    $('#tahun_akademik_update').val(data[6]);
    $('#link_bukti_dokumen_update').val(data[8]);
    $('#updateModalform').attr('action','prodi_kinerja_dosen_penelitian_dtps_update/'+ data[10]);
