  ...
  <div class="col-lg-12">
    <div class="card">
      ...
      <div class="card-header">
        <h4 style="margin-right: 70%;">Data Penelitian</h4>
          ...
          <table id="dataTable" class="table table-hover">
            <thead>
              <tr>
                ...
                <th style="text-align: center; vertical-align: middle;">Tahun Berakhirnya Kerjasama</th>
            ...
            <tbody>
             @php $no=1 @endphp
              @foreach($tridharma_penelitian as $data)
              <tr>
                <td>{{$no++}}</td>
                ...
                <td><a href="{{route('prodi-file_download_penelitian',$data->id)}}"><button class="btn btn-info ">Download</button></a></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{route('prodi_kerja_sama_tridharma_penelitian_add')}}" enctype="multipart/form-data">

          {{csrf_field()}}
          <div class="form-group">
            <label for="judul">Lembaga Mitra</label>
          ...
          <div class="form-group">
            <label for="judul">Manfaat bagi Program Studi yang Diakreditasi</label>
            <input type="text" class="form-control" id="manfaat" name="manfaat" required="" />
          </div>

          <div class="form-group">
            <label for="judul">Waktu dan Durasi</label>
            <input type="text" class="form-control" id="waktu_durasi" name="waktu_durasi" required="" />
          </div>

          <div class="form-group">
            <label for="judul">Unggah File Bukti Kerjasama (opsional)</label>
            <input type="file" class="form-control" id="file_bukti_kerjasama" name="file_bukti_kerjasama" required="" />
          </div>

          <div class="form-group">
            <label for="judul">Link Bukti Kerjasama (opsional)</label>
            <input type="text" class="form-control" id="link_bukti_kerjasama" name="link_bukti_kerjasama" />
          </div>

          <div class="form-group">
            <label for="judul">Tahun Berakhirnya Kerjasama</label>
            <input type="text" class="form-control" id="tahun_berakhir" name="tahun_berakhir" required="" />
          </div>
...
<div id="updateTriPendidikan" class="modal fade" role="dialog">
  <div class="modal-dialog ">
   <!--Modal content-->
   <form action="" id="updatetripendidikanform" method="post" enctype="multipart/form-data">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="judul">Lembaga Mitra</label>
          <input type="text" class="form-control" id="lembaga_mitra_update" name="lembaga_mitra" required="" />
        </div>

        <div class="form-group">
          <label for="judul">Tingkat</label>
          <input type="text" class="form-control" id="tingkat_update" name="tingkat" required="" />
        </div>
        ...
        <div class="form-group">
          <label for="judul">Manfaat bagi Program Studi yang Diakreditasi</label>
          <input type="text" class="form-control" id="manfaat_update" name="manfaat" required="" />
        </div>

        <div class="form-group">
          <label for="judul">Waktu dan Durasi</label>
          <input type="text" class="form-control" id="waktu_durasi_update" name="waktu_durasi" required="" />
        </div>

        <div class="form-group">
          <label for="judul">Unggah File Bukti Kerjasama (opsional)</label>
          <input type="file" class="form-control" id="file_bukti_kerjasama" name="file_bukti_kerjasama" />
        </div>

        <div class="form-group">
          <label for="judul">Link Bukti Kerjasama (opsional)</label>
          <input type="text" class="form-control" id="link_bukti_kerjasama_update" name="link_bukti_kerjasama" />
        </div>

        <div class="form-group">
          <label for="judul">Tahun Berakhirnya Kerjasama</label>
          <input type="text" class="form-control" id="tahun_berakhir_update" name="tahun_berakhir" required="" />
        </div>
        ...
        <form action="" id="deleteForm" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ csrf_field() }}
                    {{ method_field('POST') }}
                    <p>Apakah anda yakin ingin Menghapus data Kerjasama Tridharma Penelitian ini ?</p>
                    <button type="button" class="btn btn-secondary float-right" data-dismiss="modal">Batal</button>
...
<script type="text/javascript">
  function deleteData(id) {
    var id = id;
    var url = '{{route("prodi_kerja_sama_tridharma_pendidikan_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    table.on('click', '.edit', function() {
      ...
      console.log(data);
      $('#lembaga_mitra_update').val(data[1]);
      $('#tingkat_update').val(data[2]);
      $('#judul_kegiatan_update').val(data[3]);
      $('#manfaat_update').val(data[4]);
      $('#waktu_durasi_update').val(data[5]);
      $('#link_bukti_kerjasama_update').val(data[7]);
      $('#tahun_berakhir_update').val(data[8]);
      $('#updatetripendidikanform').attr('action','prodi_kerja_sama_tridharma_penelitian_update/'+ data[10]);
      $('#updateTriPendidikan').modal('show');
    });
  });
</script>
