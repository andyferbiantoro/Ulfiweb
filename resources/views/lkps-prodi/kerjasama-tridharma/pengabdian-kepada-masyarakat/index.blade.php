  ...
  <div class="col-lg-12">
    <div class="card">
      ...
      <div class="card-header">
        <h4 style="margin-right: 50%;">Data Pengabdian Kepada Masyarakat</h4>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tambah Data Pengabdian Kepada Masyarakat</h5>
        
      </div>
      <div class="modal-body">
        <form method="post" action="{{route('prodi_kerja_sama_tridharma_pkm_add')}}" enctype="multipart/form-data">
...
<div id="updateTriPkm" class="modal fade" role="dialog">
  <div class="modal-dialog ">
   <!--Modal content-->
   <form action="" id="updatetripkmform" method="post" enctype="multipart/form-data">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="" id="deleteForm" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ csrf_field() }}
                    {{ method_field('POST') }}
                    <p>Apakah anda yakin ingin Menghapus data Kerjasama Tridharma Pkm ini ?</p>
                    <button type="button" class="btn btn-secondary float-right" data-dismiss="modal">Batal</button>
...
<script>
  $(document).ready(function() {
    ...
    table.on('click', '.edit', function() {
      ...
      $('#updatetripkmform').attr('action','prodi_kerja_sama_tridharma_pkm_update/'+ data[10]);
      $('#updateTriPkm').modal('show');
    });
  });
</script>
