  ...
  <div class="col-lg-12">
    <div class="card">
      ...
      <div class="card-header">
        <h4 style="margin-right: 70%;">Data Pendidikan</h4>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="dataTable" class="table table-hover">
            ...
            <tbody>
              @php $no=1 @endphp
              @foreach($tridharma_pendidikan as $data)
              <tr>
                <td>{{$no++}}</td>
                ...
                <td><a href="{{route('prodi-file_download_pendidikan',$data->id)}}"><button class="btn btn-info ">Download</button></a></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{route('prodi_kerja_sama_tridharma_pendidikan_add')}}" enctype="multipart/form-data">
        ...
        <form action="" id="deleteForm" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ csrf_field() }}
                    {{ method_field('POST') }}
                    <p>Apakah anda yakin ingin Menghapus data Kerjasama Tridharma Pendidikan ini ?</p>
                    <button type="button" class="btn btn-secondary float-right" data-dismiss="modal">Batal</button>
...
<script>
  $(document).ready(function() {
    ...
    table.on('click', '.edit', function() {
      ...
      $('#updatetripendidikanform').attr('action','prodi_kerja_sama_tridharma_pendidikan_update/'+ data[10]);
