...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card-header">
            <h4 style="margin-right: 15%;">Data Waktu Tunggu Lulusan pada Program Sarjana Terapan</h4><br>
            <div class=" text-right">
                <button type="button" class="btn btn-success fa fa-plus" data-toggle="modal" data-target="#ModalTambah">
                    Tambah Data
                </button>
                <a href="{{route('prodi_lihat_waktu_tunggu_lulusan_program_sarajana_terapan')}}">
...
<!-- <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4>Waktu Tunggu Lulusan pada Program Sarjana Terapan</h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Waktu Tunggu Lulusan pada Program Sarjana Terapan</h5>
                
            </div>
            <div class="modal-body">
                <form method="post" action="{{route('prodi_waktu_tunggu_lulusan_program_sarjana_terapan_add')}}" enctype="multipart/form-data">
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{route("prodi_waktu_tunggu_lulusan_program_sarjana_terapan_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    $('#jumlah_lulusan_wt_3bulan_update').val(data[4]);
    $('#jumlah_lulusan_wt_3_6bulan_update').val(data[5]);
    $('#jumlah_lulusan_wt_6bulan_update').val(data[6]);
    $('#link_bukti_dokumen_update').val(data[8]);
    $('#updateModalform').attr('action','prodi_waktu_tunggu_lulusan_program_sarjana_terapan_update/'+ data[10]);
