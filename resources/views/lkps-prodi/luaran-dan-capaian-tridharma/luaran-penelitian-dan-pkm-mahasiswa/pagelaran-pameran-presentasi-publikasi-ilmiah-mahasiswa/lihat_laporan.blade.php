...
@section('title')
Laporan Pagelaran/Pameran/Presentasi/Publikasi Ilmiah Mahasiswa
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4>Data Laporan Pagelaran/Pameran/Presentasi/Publikasi Ilmiah Mahasiswa</h4>
            </div>
            <div class="card-body">
                <a href="{{route('prodi_pagelaran_pameran_prestasi_publikasi_ilmiah_mahasiswa')}}">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$data->tahun_akademik }}</td>
                                 <td><a href="{{route('prodi-file_download_dokumen_ilmiah_mahasiswa',$data->id)}}"><button class="btn btn-info ">Download</button></a></td>
