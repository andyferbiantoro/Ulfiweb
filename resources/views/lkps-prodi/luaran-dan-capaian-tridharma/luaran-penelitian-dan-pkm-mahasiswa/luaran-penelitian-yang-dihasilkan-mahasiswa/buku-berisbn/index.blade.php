...
@section('title')
Buku Ber-ISBN, Book Chapter Mahasiswa
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-header">
                <h4 style="margin-right: 43%;">Data Buku Ber-ISBN, Book Chapter Mahasiswa</h4>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="dataTable" class="table table-hover">
                        ...
                        <tbody>
                         @php $no=1 @endphp
                         @foreach($data_buku_berisbn_mhs as $data)
                         <tr>
                            <td>{{$no++ }}</td>
                            <td>{{$data->luaran_penelitian_pkm }}</td>
                            <td>{{$data->tahun }}</td>
                            <td>{{$data->keterangan }}</td>
                            <td><a href="{{route('prodi-file_download_file_buku_berisbn_mhs',$data->id)}}"><button class="btn btn-info ">Download</button></a></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('prodi_mahasiswa_buku_berisbn_add')}}" enctype="multipart/form-data">
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{route("prodi_mahasiswa_buku_berisbn_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    $('#updateModalform').attr('action','prodi_mahasiswa_buku_berisbn_update/'+ data[7]);
