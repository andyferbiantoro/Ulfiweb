...
@section('title')
Teknologi Tepat Guna, Produk, Karya Seni, Rekayasa Sosial Mahasiswa
@endsection
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card-header">
            <h4 style="margin-right: 18%;">Data Teknologi Tepat Guna, Produk, Karya Seni, Rekayasa Sosial Mahasiswa</h4>
        ...
        <div class="card-body">
            <div class="text-right">
                <form class="form-inline">
                    <div class="form-group mx-sm-1 mb-2">
                        ...
                        <input type="text" class="form-control" id="th_ak" placeholder="Tahun">
                    </div>
            ...
            <div class="table-responsive">
                <table id="dataTable" class="table table-hover">
                    ...
                    <tbody>
                       @php $no=1 @endphp
                       @foreach($data_teknologi_tepat_guna_mhs as $data)
                       <tr>
                        <td>{{$no++ }}</td>
                        <td>{{$data->luaran_penelitian_pkm }}</td>
                        <td>{{$data->tahun }}</td>
                        <td>{{$data->keterangan }}</td>
                        <td><a href="{{route('prodi-file_download_file_teknologi_tepat_guna_mhs',$data->id)}}"><button class="btn btn-info ">Download</button></a></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('prodi_mahasiswa_teknologi_tepat_guna_add')}}" enctype="multipart/form-data">
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{route("prodi_mahasiswa_teknologi_tepat_guna_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    $('#updateModalform').attr('action','prodi_mahasiswa_teknologi_tepat_guna_update/'+ data[7]);
