...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card-header">
            <h4 style="margin-right: 15%;">Data Masa Studi Lulusan pada Program Sarjana Terapan</h4><br>
            <div class=" text-right">
                <button type="button" class="btn btn-success fa fa-plus" data-toggle="modal" data-target="#ModalTambah">
                    Tambah Data
                </button>
                <a href="{{route('prodi_lihat_masa_studi_lulusan_program_sarjana_terapan')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('prodi_masa_studi_lulusan_program_sarajana_terapan_add')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="judul">Jumlah Mahasiswa yang Lulus pada Akhir TS-6</label>
                        <input type="text" class="form-control" id="jumlah_mahasiswaLulus_akhirTs6" name="jumlah_mahasiswaLulus_akhirTs6" required="" />
                    </div>
                    <div class="form-group">
                        <label for="judul">Jumlah Mahasiswa yang Lulus pada Akhir TS-5</label>
                        <input type="text" class="form-control" id="jumlah_mahasiswaLulus_akhirTs5" name="jumlah_mahasiswaLulus_akhirTs5" required="" />
                    </div>
...
<div id="updateModal" class="modal fade" role="dialog">
  ...
  <div class="modal-body">
    ...
    <div class="form-group">
        <label for="judul">Jumlah Mahasiswa yang Lulus pada Akhir TS-6</label>
        <input type="text" class="form-control" id="jumlah_mahasiswaLulus_akhirTs6_update" name="jumlah_mahasiswaLulus_akhirTs6" required="" />
    </div>

    <div class="form-group">
        <label for="judul">Jumlah Mahasiswa yang Lulus pada Akhir TS-5</label>
        <input type="text" class="form-control" id="jumlah_mahasiswaLulus_akhirTs5_update" name="jumlah_mahasiswaLulus_akhirTs5" required="" />
    </div>
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{route("prodi_masa_studi_lulusan_program_sarajana_terapan_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    $('#jumlah_mahasiswaLulus_akhirTs6_update').val(data[3]);
    $('#jumlah_mahasiswaLulus_akhirTs5_update').val(data[4]);
    $('#jumlah_mahasiswaLulus_akhirTs4_update').val(data[5]);
    $('#jumlah_mahasiswaLulus_akhirTs3_update').val(data[6]);
    $('#jumlah_mahasiswaLulus_akhirTs2_update').val(data[7]);
    $('#jumlah_mahasiswaLulus_akhirTs1_update').val(data[8]);
    $('#jumlah_mahasiswaLulus_akhirTs_update').val(data[9]);
    $('#rataRata_masa_studi_update').val(data[11]);
    $('#link_bukti_dokumen_update').val(data[13]);
    $('#updateModalform').attr('action','prodi_masa_studi_lulusan_program_sarajana_terapan_update/'+ data[15]);
