    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-header">
                <h4 style="margin-right: 45%;">Data Tempat Kerja Lulusann</h4><br>
                <div class=" text-right">
                    <button type="button" class="btn btn-success fa fa-plus" data-toggle="modal" data-target="#ModalTambah">
                        Tambah Data
                    </button>
                    <a href="{{route('prodi_lihat_tempat_kerja_lulusan')}}">
                    ...
                    <table id="" class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{$jumlah_lulusan_lokal }}</td>
                                <td>{{$jumlah_lulusan_nasional }}</td>
                                <td>{{$jumlah_lulusan_multinasional }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Tempat Kerja Lulusan</h5>
                
            </div>
            <div class="modal-body">
                <form method="post" action="{{route('prodi_tempat_kerja_lulusan_add')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="judul">Jumlah Lulusan Terlacak yang Bekerja Berdasarkan Tingkat/ Ukuran Tempat Kerja/ Berwirausaha (Lokal/ Wilayah/ Berwirausaha tidak Berbadan Hukum)</label>
                        <input type="text" class="form-control" id="jumlah_lulusan_lokal" name="jumlah_lulusan_lokal" required="" placeholder="" />
                    </div>
                    <div class="form-group">
                        <label for="judul">Jumlah Lulusan Terlacak yang Bekerja Berdasarkan Tingkat/ Ukuran Tempat Kerja/ Berwirausaha (Nasional/ Berwirausaha Berbadan Hukum) </label>
                        <input type="text" class="form-control" id="jumlah_lulusan_nasional" name="jumlah_lulusan_nasional" required="" placeholder="" />
                    </div>
                    <div class="form-group">
                        <label for="judul">Jumlah Lulusan Terlacak yang Bekerja Berdasarkan Tingkat/ Ukuran Tempat Kerja/ Berwirausaha (Multinasional/ Internasinal) </label>
                        <input type="text" class="form-control" id="jumlah_lulusan_multinasional" name="jumlah_lulusan_multinasional" required="" placeholder="" />
                    </div>
  ...
  <div class="modal-dialog ">
     ...
     <form action="" id="updateModalform" method="post" enctype="multipart/form-data">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label for="judul">Jumlah Lulusan Terlacak yang Bekerja Berdasarkan Tingkat/ Ukuran Tempat Kerja/ Berwirausaha (Lokal/ Wilayah/ Berwirausaha tidak Berbadan Hukum)</label>
            <input type="text" class="form-control" id="jumlah_lulusan_lokal_update" name="jumlah_lulusan_lokal" required="" placeholder="" />
        </div>
        <div class="form-group">
            <label for="judul">Jumlah Lulusan Terlacak yang Bekerja Berdasarkan Tingkat/ Ukuran Tempat Kerja/ Berwirausaha (Nasional/ Berwirausaha Berbadan Hukum) </label>
            <input type="text" class="form-control" id="jumlah_lulusan_nasional_update" name="jumlah_lulusan_nasional" required="" placeholder="" />
        </div>
        <div class="form-group">
            <label for="judul">Jumlah Lulusan Terlacak yang Bekerja Berdasarkan Tingkat/ Ukuran Tempat Kerja/ Berwirausaha (Multinasional/ Internasinal) </label>
            <input type="text" class="form-control" id="jumlah_lulusan_multinasional_update" name="jumlah_lulusan_multinasional" required="" placeholder="" />
        </div>
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{route("prodi_tempat_kerja_lulusan_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    $('#jumlah_lulusan_lokal_update').val(data[4]);
    $('#jumlah_lulusan_nasional_update').val(data[5]);
    $('#jumlah_lulusan_multinasional_update').val(data[6]);
    $('#link_bukti_dokumen_update').val(data[8]);
    $('#updateModalform').attr('action','prodi_tempat_kerja_lulusan_update/'+ data[10]);
