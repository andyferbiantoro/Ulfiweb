    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-header">
                <h4 style="margin-right: 50%;">Data Prestasi Akademik Mahasiswa</h4><br>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="dataTable" class="table table-hover">
                        ...
                        <tbody>
                           @php $no=1 @endphp
                           @foreach($prestasi_akademik_mahasiswa as $data)
                           <tr>
                            <td>{{$no++ }}</td>
                            ...
                            <td><a href="{{route('prodi-file_download_dokumen_prestasi_akademik',$data->id)}}"><button class="btn btn-info ">Download</button></a></td>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p style="font-size: 10px;">
                    1. Prestasi akademik yang dicapai mahasiswa Program Studi dalam 5 tahun terakhir <br>
                    2. Unggah File dengan Format (jpg/png/word/pdf/excel/rar/zip) dan Link Drive Bukti Dokumen seperti : <br>
                    a. Kebijakan mutu <br>
                    b. Manual mutu <br>
                    c. Standar mutu <br>
                    d. Buku pedoman pengembangan prestasi akademik mahasiswa <br>
                    ...
                    h. Dokumen pendukung seperti sertifikat/piagam penghargaan/piala/medali, foto kegiatan, laporan kegiatan dan daftar mahasiswa prestasi akademik
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('prodi_prestasi_akademik_mahasiswa_add')}}" enctype="multipart/form-data">
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{route("prodi_prestasi_akademik_mahasiswa_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    $('#updateModalform').attr('action','prodi_prestasi_akademik_mahasiswa_update/'+ data[8]);
