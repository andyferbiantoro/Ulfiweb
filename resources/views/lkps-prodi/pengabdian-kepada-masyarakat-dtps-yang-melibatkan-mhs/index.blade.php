    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('prodi_pkm_dtps_yang_melibatkan_mahasiswa_add')}}" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label for="judul">Tema pkm sesuai Roadmap</label>
                    <input type="text" class="form-control" id="tema_pkm" name="tema_pkm" required="" placeholder="" />
                </div>
...
<div id="updateModal" class="modal fade" role="dialog">
  ...
  <div class="modal-body">
    ...
    <div class="form-group">
        <label for="judul">Tema pkm sesuai Roadmap</label>
        <input type="text" class="form-control" id="tema_pkm_update" name="tema_pkm" required="" placeholder="" />
    </div>
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{route("prodi_pkm_dtps_yang_melibatkan_mahasiswa_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    $('#updateModalform').attr('action','prodi_pkm_dtps_yang_melibatkan_mahasiswa_update/'+ data[9]);
