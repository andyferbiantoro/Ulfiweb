    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-header">
                <h4>Data Dosen industri / Praktisi</h4>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p style="font-size: 10px;">
                    ...
                    3. Unggah file dengan format (word/pdf/rar/zip) dan link drive Bukti Dokumen Surat Keputusan tentang Pengampu Mata Kuliah dan Beban Mengajar (Jumlah sks) </p>
            </div>
        </div>
    </div>
</div>
